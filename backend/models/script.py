...
class Script(Base, TimestampMixin):
    ...
    associated_ide: Mapped[Optional[str]] = mapped_column(String(100))
    ...
    task_type: Mapped[Optional[str]] = mapped_column(String(30))
    ...
    default_config_json: Mapped[Optional[str]] = mapped_column(Text)
