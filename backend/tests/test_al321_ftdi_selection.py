...
class Al321FtdiSelectionTests(unittest.TestCase):
    def test_location_bound_ftdi_serial_is_inferred_for_al321_sram(self):
    ...
    def test_location_bound_ftdi_serial_is_inferred_for_al321_flash(self):
        env = build_runtime_env(
            _Task(),
    ...
    def test_location_derived_windows_suffix_is_not_used_as_al321_serial(self):
        env = build_runtime_env(
            _Task(),
            {"execution_operation": "Flash固化"},
            None,
            _Burner(location=r"USB\VID_0403&PID_6014\7&16B090BC&0&2"),
            _Script(),
            None,
        )
